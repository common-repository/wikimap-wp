...
<?php endif; ?>
			<geo:Point>
  				<geo:lat><?php echo get_post_meta($post->ID, 'Lat', 'true'); ?></geo:lat>
  				<geo:long><?php echo get_post_meta($post->ID, 'Lon', 'true'); ?></geo:long>
			</geo:Point>              
</entry>
  <?php } $items_count++; if (($items_count == 99999) && empty($m)) { break; } } } ?>
</feed>
